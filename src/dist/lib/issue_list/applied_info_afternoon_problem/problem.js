...
exports.getAppliedInfoAfternoonProblemById = exports.appliedInfoAfternoonProblems = void 0;
exports.appliedInfoAfternoonProblems = [
    {
        id: 'APM1',
...
const getAppliedInfoAfternoonProblemById = (id) => {
    return exports.appliedInfoAfternoonProblems.find(p => p.id === id);
};
exports.getAppliedInfoAfternoonProblemById = getAppliedInfoAfternoonProblemById;
