...
exports.getNextPythonProblemId = exports.getPythonProblemById = exports.pythonProblems = void 0;
exports.pythonProblems = [
    {
        id: 'P1',
 ...
 */
const getPythonProblemById = (id) => {
    return exports.pythonProblems.find(p => p.id === id);
};
exports.getPythonProblemById = getPythonProblemById;
/**
 * 現在の問題IDを受け取り、次の問題のIDを返す
 * @param currentId 現在の問題ID (例: 'P1')
 * @returns 次の問題ID (例: 'P2')、最後の問題の場合はnull
 */
const getNextPythonProblemId = (currentId) => {
    const currentIndex = exports.pythonProblems.findIndex(p => p.id === currentId);
    if (currentIndex === -1 || currentIndex >= exports.pythonProblems.length - 1) {
        return null; // 次の問題はない
    }
    return exports.pythonProblems[currentIndex + 1].id;
};
exports.getNextPythonProblemId = getNextPythonProblemId;
