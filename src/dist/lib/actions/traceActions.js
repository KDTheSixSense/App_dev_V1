...
以上のルールと例を厳守し、ユーザーの指示に対する疑似言語コードのみを、説明や\`\`\`なしで直接生成してください。`;
    try {
        ...
        const generatedText = (_c = (_b = (_a = result.choices) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.message) === null || _c === void 0 ? void 0 : _c.content;
        if (!generatedText) {
