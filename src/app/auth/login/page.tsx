          ...
          >
            ...
            <div className="flex justify-between items-center mt-6 mb-4">
              ...
              <button
                ...
                className={`flex items-center justify-center gap-2 rounded-lg border border-white/20 bg-white/10 px-4 py-2 font-semibold text-white backdrop-blur-md transition-all hover:bg-white/20 ${loading ? 'opacity-50 cursor-not-allowed' : ''
                  }`}
              >
                {/* ★ SVGコンポーネントに変更 */}
              ...
              <button
                type="submit"
                disabled={loading}
                className={`group rounded-lg bg-gradient-to-r from-cyan-500 to-blue-600 px-6 py-2 font-bold text-white shadow-lg shadow-cyan-500/25 transition-all hover:scale-105 hover:shadow-cyan-500/50 ${loading ? 'opacity-50 cursor-not-allowed scale-100' : ''
                  }`}
              >
                {loading ? 'ログイン中...' : 'ログイン'}
              </button>
