...
export const mineIssueListHelpSteps: HelpStep[] = [
  // 作成した問題一覧ページ
  {
    ...
    title: "作成した問題一覧",
    description: "このページでは、自分が作成した問題の一覧を確認できます。問題を編集したり、問題を削除することができます。",
  ...
  },
  {
    id: "mine_issue_list_overview",
    title: "編集と削除",
    description: "このページでは、自分が作成した問題を一覧で確認できます。問題の内容を編集したり、削除や公開・非公開の設定を簡単に変更できます。はじめての方でも使いやすいように、分かりやすく整理されています。",
