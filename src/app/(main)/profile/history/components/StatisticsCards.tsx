    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-xl shadow-sm border border-blue-200">
                ...
                <p className="text-3xl font-bold text-gray-800">{stats.total}<span className="text-base font-normal text-gray-500 ml-1">問</span></p>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 p-4 rounded-xl shadow-sm border border-green-200">
                ...
                <p className="text-3xl font-bold text-gray-800">{stats.correct}<span className="text-base font-normal text-gray-500 ml-1">問</span></p>
            </div>
