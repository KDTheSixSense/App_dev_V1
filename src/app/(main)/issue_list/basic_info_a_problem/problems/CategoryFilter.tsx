...
export default function CategoryFilter() {
  ...
  useEffect(() => {
    const savedCategory = localStorage.getItem('basic_info_a_filter_category');
    const savedStatus = localStorage.getItem('basic_info_a_filter_status');
  ...
  const updateParams = (key: string, value: string) => {
    localStorage.setItem(`basic_info_a_filter_${key}`, value);
    const params = new URLSearchParams(searchParams.toString());
    if (value === 'all') {
      params.delete(key);
    } else {
