// src/app/(main)/issue_list/python_problem/[problemId]/page.tsx
'use client';
...
// Python問題用のデータソースを正しくインポート
import { getPythonProblemsById } from '@/lib/issue_list/python_problem/problem';
...
const ProblemDetailPage = () => {
  ...
  // 問題データ取得関数を正しく呼び出し
  const initialProblemData = getPythonProblemsById(problemId);
  ...
  useEffect(() => {
    // 問題データ取得関数を正しく呼び出し
    const currentProblem = getPythonProblemsById(problemId);
