// src/app/(main)/issue_list/Cplus_problem/[problemId]/page.tsx
'use client';
...
import { getCplusProblemsById } from '@/lib/issue_list/Cplus_problem/problem'; // C++問題用のデータソースをインポート
...
const ProblemDetailPage = () => {
  ...
  // 問題データ取得関数を正しく呼び出し
  const initialProblemData = getCplusProblemsById(problemId);
  ...
  useEffect(() => {
    // 問題データ取得関数を正しく呼び出し
    const currentProblem = getCplusProblemsById(problemId);
