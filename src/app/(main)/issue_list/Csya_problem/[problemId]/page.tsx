// src/app/(main)/issue_list/Csya_problem/[problemId]/page.tsx
'use client';
...
import { getCsyaProblemsById } from '@/lib/issue_list/Csya_problem/problem'; // C#問題用のデータソースをインポート
...
const ProblemDetailPage = () => {
  ...
  // 問題データ取得関数を正しく呼び出し
  const initialProblemData = getCsyaProblemsById(problemId);
  ...
  useEffect(() => {
    // 問題データ取得関数を正しく呼び出し
    const currentProblem = getCsyaProblemsById(problemId);
