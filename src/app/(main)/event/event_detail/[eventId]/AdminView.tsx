        ...
        <div className="bg-white rounded-2xl shadow-lg border border-white/50 backdrop-blur-sm p-6 mb-8 relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-start gap-6 mb-6">
            <div>
              ...
              <div>
                <h3 className="text-base font-bold text-slate-900 mb-2">イベント作成者</h3>
                <div className="flex items-center gap-3 bg-slate-50 border border-slate-200 pr-5 py-1.5 rounded-full w-fit">
                  {event.creator?.icon ? (
                    <img
                      src={event.creator.icon}
                      alt={event.creator.username ?? 'Creator'}
                      className="w-8 h-8 rounded-full object-cover border border-white shadow-sm"
                    />
                  ) : (
                    <div className="flex justify-center items-center w-8 h-8 rounded-full bg-gradient-to-br from-cyan-100 to-sky-100 text-cyan-700 font-bold text-xs border border-white shadow-sm">
                  ...
                  <p className="text-sm text-slate-700 font-bold flex items-center gap-2">
                    ...
                    <span className="bg-cyan-100 text-cyan-800 text-[10px] px-2 py-0.5 rounded-full border border-cyan-200">管理者</span>
                  </p>
                </div>
              </div>
            </div>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-slate-400">
                            参加: {(participant as any).joinedAt ? new Date((participant as any).joinedAt).toLocaleDateString() : '不明'}
                          </p>
                        </div>
                      </div>
