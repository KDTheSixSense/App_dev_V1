...
import {
  ...
  getGroupsAction,
  joinGroupAction,
} from "@/lib/actions"; // グループ作成アクションをインポート
...
const GroupClientPage: React.FC<GroupClientPageProps> = ({
  ...
  // ★ 修正: ページ読み込み時に一度だけグループ一覧を取得 ---> initialGroupsで置き換え
  useEffect(() => {
    // initialGroups を既に持っているので、初回フェッチは不要
    // ただし、Server ActionのrevalidatePathが機能しない環境の場合、
    // ここで fetchGroups() を呼ぶことで最新の状態を保つことも検討する
                ...
                {(["お知らせ", "課題", "メンバー"] as const).map((tab) => (
                  <button
                    ...
                    style={{
                      ...
                      fontWeight: "500",
                      marginRight: "16px",
                      borderBottom: `${activeTab === tab ? "#00bcd4" : "transparent"}`,
                          ...
                          >
                            ...
                            <button
                              ...
                              style={{
                                padding: "6px 8px",
                                border: "1px solid #e0e0e0",
                                backgroundColor: formatState.bold
                                  ? "#e3f2fd"
                                  : "#fff",
                                borderRadius: "4px",
                                cursor: "pointer",
                            ...
                            <button
                              ...
                              style={{
                                padding: "6px 8px",
                                border: "1px solid #e0e0e0",
                                backgroundColor: formatState.italic
                                  ? "#e3f2fd"
                                  : "#fff",
                                borderRadius: "4px",
                                cursor: "pointer",
              ...
              <div style={{ marginBottom: "40px" }}>
                ...
                >
                  ...
                  <div style={{ padding: "8px 0" }}>
                    ...
                    <ToggleSwitch
                      id="commentsOnMyPosts"
                      label="自分の投稿へのコメント"
                      checked={notificationSettings.commentsOnMyPosts}
                      onChange={handleNotificationChange}
                    />
                    <ToggleSwitch
                      id="commentsThatMentionMe"
                      label="自分の名前がリンク付きのコメント"
                      checked={notificationSettings.commentsThatMentionMe}
                      onChange={handleNotificationChange}
                    />
                    <ToggleSwitch
                      id="privateCommentsOnWork"
                      label="課題に関する限定公開のコメント"
                      checked={notificationSettings.privateCommentsOnWork}
                      onChange={handleNotificationChange}
                    />
                  </div>
                  <hr
                  ...
                  <div style={{ padding: "8px 0 16px" }}>
                    ...
                    <ToggleSwitch
                      id="submittedLate"
                      label="教師からの課題やその他の投稿"
                      checked={notificationSettings.submittedLate}
                      onChange={handleNotificationChange}
                    />
                    <ToggleSwitch
                      id="resubmitted"
                      label="教師から返却された課題と成績"
                      checked={notificationSettings.resubmitted}
                      onChange={handleNotificationChange}
                    />
                    <ToggleSwitch
                      id="invitationsToCoTeach"
                      label="生徒としてクラスへ招待"
                      checked={notificationSettings.invitationsToCoTeach}
                      onChange={handleNotificationChange}
                    />
          ...
          >
            ...
            <div style={{ marginBottom: "24px", position: "relative" }}>
              <input
                ...
                onChange={(e) =>
                  setCreateGroupForm({ ...createGroupForm, className: e.target.value })
                }
                style={{
                  width: "100%",
            ...
            >
              ...
              <button
                ...
                style={{
                  padding: "12px 24px",
                  border: "none",
                  backgroundColor: createGroupForm.className.trim()
                    ? "#2196f3"
                    : "#e0e0e0",
                  color: createGroupForm.className.trim() ? "#fff" : "#9e9e9e",
                  cursor: createGroupForm.className.trim()
                    ? "pointer"
                    : "not-allowed",
                  borderRadius: "4px",
                  fontSize: "14px",
