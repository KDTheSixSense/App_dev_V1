  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="bg-white p-6 md:p-10 rounded-lg shadow-sm">
        <h1 className="text-3xl font-bold mb-8 text-center text-gray-800">プライバシーポリシー</h1>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-4 border-b pb-2 border-gray-200">第1条（個人情報保護に関する基本方針）</h2>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-4 border-b pb-2 border-gray-200">第3条（チーム情報）</h2>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-4 border-b pb-2 border-gray-200">第4条（個人情報の取得方法）</h2>
          <p className="text-gray-700">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-4 border-b pb-2 border-gray-200">第5条（個人情報の利用目的）</h2>
          <p className="mb-2 text-gray-700">Infopiaが個人情報を収集・利用する目的は，以下のとおりです。</p>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-4 border-b pb-2 border-gray-200">第6条（個人データの安全管理措置）</h2>
          <p className="text-gray-700">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-4 border-b pb-2 border-gray-200">第7条（個人データの共同利用）</h2>
          <p className="text-gray-700">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-4 border-b pb-2 border-gray-200">第8条（個人データの第三者提供）</h2>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-4 border-b pb-2 border-gray-200">第9条（個人情報の開示・訂正等の手続き）</h2>
          <ol className="list-decimal pl-6 space-y-2 text-gray-700">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-4 border-b pb-2 border-gray-200">第10条（個人情報の利用停止等）</h2>
          <ol className="list-decimal pl-6 space-y-2 text-gray-700">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-4 border-b pb-2 border-gray-200">第11条（SSLセキュリティについて）</h2>
          <p className="text-gray-700">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-4 border-b pb-2 border-gray-200">第12条（Cookie（クッキー）について）</h2>
          <ol className="list-decimal pl-6 space-y-2 text-gray-700">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-4 border-b pb-2 border-gray-200">第13条（お問い合わせ窓口）</h2>
          <p className="mb-2 text-gray-700">本ポリシーに関するお問い合わせは，下記の窓口までお願いいたします。</p>
          <ul className="list-disc pl-6 space-y-2 text-gray-700">
            <li>チーム名：Infopia</li>
