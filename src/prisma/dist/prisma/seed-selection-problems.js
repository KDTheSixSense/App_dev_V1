...
exports.seedSampleSelectionProblems = seedSampleSelectionProblems;
exports.seedSelectProblemsFromExcel = seedSelectProblemsFromExcel;
...
async function seedSelectProblemsFromExcel(prisma) {
    ...
    const filePath = path_1.default.join(process.cwd(), 'app', '(main)', 'issue_list', 'selects_problems', 'data', excelFileName);
    ...
    try {
        ...
        const answerIndexMap = { 'A': 0, 'B': 1, 'C': 2, 'D': 3, 'ア': 0, 'イ': 1, 'ウ': 2, 'エ': 3 };
        let createdCount = 0;
        let updatedCount = 0;
