...
exports.seedHistoryDummy = seedHistoryDummy;
const date_fns_1 = require("date-fns");
async function seedHistoryDummy(prisma) {
    ...
    const lastWeek = (0, date_fns_1.subDays)(today, 5);
    const lastMonth = (0, date_fns_1.subMonths)(today, 1);
    const oldDate = (0, date_fns_1.subYears)(today, 1);
        ...
        for (const date of dates) {
            await prisma.userAnswer.create({
                data: {
                    ...
                    answer: '1',
                    isCorrect: randomBoolean(),
                    answeredAt: (0, date_fns_1.subDays)(date, 1), // Slightly different time
        ...
        for (const date of dates) {
            await prisma.userAnswer.create({
                data: {
                    ...
                    answer: 'print("hello")',
                    isCorrect: randomBoolean(),
                    answeredAt: (0, date_fns_1.subDays)(date, 2),
        ...
        for (const date of dates) {
            await prisma.userAnswer.create({
                data: {
                    ...
                    answer: 'Option 1',
                    isCorrect: randomBoolean(),
                    answeredAt: (0, date_fns_1.subDays)(date, 3),
