                ...
                <div key={index} className="border rounded-lg p-4 bg-gray-50">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm font-mono">
                    ...
                    <div>
                      ...
                      <pre className={`bg-white border p-2 rounded whitespace-pre-wrap min-h-[2.5rem] ${
                        result.isCorrect ? 'text-gray-800 border-gray-300' : 'text-red-600 border-red-300 bg-red-50'
                      }`}>
                        {result.actualOutput}
                      </pre>
                    </div>
